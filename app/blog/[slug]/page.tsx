    ...
    <article className="relative min-h-svh overflow-x-clip bg-[#f7f4ed] pb-16 pt-24 text-[#171717]">
      ...
      <section className="mx-auto w-full max-w-3xl px-4 sm:px-6">
        <div className="rounded-[28px] border border-[#e5e0d5] bg-[#fffdf8]/82 px-5 py-6 shadow-[0_24px_70px_-48px_rgba(23,23,23,0.55)] backdrop-blur sm:px-8 sm:py-8">
          ...
          <div className="prose mt-9 max-w-none text-[16.5px] text-zinc-800 [&_a]:font-medium [&_a]:text-[#8a4a2a] [&_a:hover]:underline [&_blockquote]:my-5 [&_blockquote]:rounded-2xl [&_blockquote]:border [&_blockquote]:border-[#e5e0d5] [&_blockquote]:bg-[#f7f4ed]/65 [&_blockquote]:px-5 [&_blockquote]:py-3.5 [&_blockquote]:text-zinc-700 [&_blockquote]:shadow-inner [&_:not(pre)>code]:rounded-md [&_:not(pre)>code]:bg-[#f7f4ed] [&_:not(pre)>code]:px-1.5 [&_:not(pre)>code]:py-0.5 [&_:not(pre)>code]:font-mono [&_:not(pre)>code]:text-sm [&_h1]:font-poppins [&_h1]:text-3xl [&_h1]:font-semibold [&_h1]:tracking-tight [&_h1]:text-zinc-950 [&_h2]:mb-2.5 [&_h2]:mt-8 [&_h2]:font-poppins [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:tracking-tight [&_h2]:text-zinc-950 [&_h3]:mb-2 [&_h3]:mt-6 [&_h3]:font-poppins [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:text-zinc-900 [&_li]:pl-1 [&_li]:leading-7 [&_ol]:my-3.5 [&_ol]:list-decimal [&_ol]:space-y-1 [&_ol]:pl-7 [&_p]:my-3 [&_p]:leading-[1.65] [&_pre]:my-6 [&_pre]:overflow-x-auto [&_pre]:rounded-2xl [&_pre]:border [&_pre]:border-[#d4c7b6] [&_pre]:bg-[linear-gradient(160deg,#1f1c18_0%,#26221d_100%)] [&_pre]:p-6 [&_pre]:text-[#f5efe4] [&_pre]:shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_18px_35px_-26px_rgba(23,23,23,0.7)] [&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_pre_code]:font-sans [&_pre_code]:text-[15px] [&_pre_code]:font-medium [&_pre_code]:leading-8 [&_pre_code]:tracking-[0.01em] [&_table]:my-5 [&_table]:w-full [&_table]:overflow-hidden [&_table]:rounded-2xl [&_table]:border [&_table]:border-[#e5e0d5] [&_table]:bg-white/70 [&_td]:border-t [&_td]:border-[#e5e0d5] [&_td]:px-4 [&_td]:py-3 [&_th]:bg-[#f7f4ed] [&_th]:px-4 [&_th]:py-3 [&_th]:text-left [&_ul]:my-3.5 [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-7">
