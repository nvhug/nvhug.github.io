// Shared between app/login/LoginForm.tsx and app/_landing/SignInButtons.tsx —
// one visual mark for "Sign in with Google/Facebook", not two copies to keep in sync.
