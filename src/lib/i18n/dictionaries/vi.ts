export const vi = {
  ...
  donate: {
    ...
    body: 'App này được duy trì nhờ sự ủng hộ của bạn. Nếu thấy hữu ích, một khoản donate nhỏ để giúp mình duy trì và phát triển nó.',
  ...
  tuVi: {
    ...
    submitGenerating: 'Đang lập luận giải...',
