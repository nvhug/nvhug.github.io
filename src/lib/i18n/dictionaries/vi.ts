export const vi = {
  ...
  tuVi: {
    ...
    generateTitle: 'Chưa có luận giải cho tháng này',
    generateHint: 'Lá số đã được lập sẵn. Nhấn để AI viết phần luận giải và lưu lại — lần sau vào chỉ cần đọc.',
    generateAction: 'Tạo luận giải',
