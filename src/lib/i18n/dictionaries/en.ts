...
export const en: Dictionary = {
  ...
  tuVi: {
    ...
    generateTitle: 'No reading for this month yet',
    generateHint: 'The chart is already computed. Generate the written reading once and it is saved — later visits just read it back.',
    generateAction: 'Generate reading',
